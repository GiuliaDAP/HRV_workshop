function HRVparams = InitializeHRVparams_workshop(project_name)
%
...
switch project_name   
    ...
    case 'demo_workshop'                   % Update with your project name
        HRVparams.Fs = 360;                % Spacify sampling frequency
        HRVparams.readdata = [pwd filesep 'workshop_data'];   % (Optional) Specify name for data input folder
        HRVparams.writedata = [pwd filesep 'results'];        % (Optional) Specify name for data output folder
